        ...
        return (
            <div>
                ...
                <form onSubmit={this.handelSubmit}>
                    ...
                    <input className={ password && "error" } name="password" type="password" value={this.state.password} onChange={this.handelInput} /> <br/>
                    <label >Confirm Password</label> <br/>
                    <input className={ confirmPass && "error" } name="confirmPass" type="password" value={this.state.confirmPass} onChange={this.handelInput} /> <br/>
